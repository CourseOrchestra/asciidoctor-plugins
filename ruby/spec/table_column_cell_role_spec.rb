...
require 'asciidoctor'
require_relative '../lib/curs/asciidoctor/extensions/table_column_cell_role'

describe 'Table with column role specifications' do
  context 'convert to html5' do
    it 'should produce a table with column roles' do
      input = <<~'ADOC'
